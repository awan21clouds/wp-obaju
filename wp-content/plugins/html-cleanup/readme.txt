...
= 1.2.4 =
* Regain compatibility with Wordpress caching plugins which hook the page load very early.
...
= 1.2.5 =
HTML Cleanup's advertised plugin homepage is now correct. No changes to HTML Cleanup functionality.
