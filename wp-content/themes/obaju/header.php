                                ...
                                <div class="yamm-content">
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <h5>Clothing</h5>
                                            <ul>
                                                <li><a href="<?php get_page_link(43); ?> ">T-shirts</a>
                                                </li>
                                                <li><a href="<?php get_page_link(43); ?> ">Shirts</a>
                                                </li>
                                                <li><a href="<?php get_page_link(43); ?> ">Pants</a>
                                                </li>
                                                <li><a href="<?php get_page_link(43); ?> ">Accessories</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="col-sm-3">
                                            <h5>Shoes</h5>
                                            <ul>
                                                <li><a href="<?php get_page_link(43); ?> ">Trainers</a>
                                                </li>
                                                <li><a href="<?php get_page_link(43); ?> ">Sandals</a>
                                                </li>
                                                <li><a href="<?php get_page_link(43); ?> ">Hiking shoes</a>
                                                </li>
                                                <li><a href="<?php get_page_link(43); ?> ">Casual</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="col-sm-3">
